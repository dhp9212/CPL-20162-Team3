...
public class MainActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    static final UUID BLUE_UUID = UUID.fromString("fa87c0d0-afac-11de-8a39-0800200c9a66"); // 접속시 사용하는 고유 ID
